...
public class Menu {
	...
	public Menu() {
		super();
		listeurPizza = new ListerPizzasOptionMenu();
		createurPizza = new NouvellePizzaOptionMenu();
		supprimeurPizza = new SupprimerPizzaOptionMenu();
		modifieurPizza = new ModifierPizzaOptionMenu();
